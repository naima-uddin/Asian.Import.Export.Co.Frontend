...
export const metadata = {
  ...
  description:
    "Learn about Asian Import Export Co LTD's shipping and delivery services. Flexible payment terms, worldwide delivery, and comprehensive logistics support.",
  keywords: [
  ...
  openGraph: {
    title: "Shipping & Delivery - Asian Import Export Co LTD",
    description:
