...
export const metadata = {
  ...
  description:
    "Read Asian Import Export Co LTD's privacy policy. Learn how we protect your personal information, handle cookies, and maintain data security.",
  keywords: [
    "privacy policy",
    "data protection",
    "cookie policy",
  ...
  openGraph: {
    title: "Privacy Policy - Asian Import Export Co LTD",
    description:
